...
def get_space_usage(sequences):
    ...
    many sequences were generated divided by the maximum number of sequences
    generated by a register of this size.
    """
    return (len(sequences) / (2 ** len(sequences[0]))) * 100
